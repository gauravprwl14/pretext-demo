  ...
  return (
    <section className="py-24 px-6 bg-black border-t border-white/10">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Evaluation badge */}
        <div className="mt-6 p-4 border border-white/10 rounded-xl bg-white/[0.02] flex gap-6 text-sm flex-wrap">
          <span className="text-white/40">
            Prompt: <span className="text-amber-400/70">Physics Was Wrong</span>
          </span>
          <span className="text-white/40">
            Novelty: <span className="text-green-400">9/10</span>
          </span>
          <span className="text-white/40">
            Stop-scroll: <span className="text-green-400">8/10</span>
          </span>
          <span className="text-white/40">
            Pretext clarity: <span className="text-amber-400">6/10</span>
          </span>
          <span className="text-white/40">
            Interactivity: <span className="text-green-400">9/10</span>
          </span>
        </div>
